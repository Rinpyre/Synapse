...
\begin{itemize}
    ...
    \item \textit{Project Management Tool:} We will use a Github Project board to manage our tasks and milestones. This will allow us to track our progress, assign tasks and get our tasks done on deadline.
