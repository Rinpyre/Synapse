...
\begin{itemize}
    ...
    \item \textit{Containerisation:} The entire system should be containerised using Docker to ensure consistency across different environments and ease of deployment.
...
\begin{itemize}
    ...
    \item \textit{Usability:} The frontend interface should be intuitive and easy to navigate, allowing users of varying technical expertise to effectively utilise the system.
